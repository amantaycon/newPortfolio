...
const skillCategories = [
  {
    ...
    icon: <FiServer />,
    skills: [
      { name: "Spring Boot", value: 85, status: "OPTIMAL" },
      { name: "Node.js / Express", value: 80, status: "ACTIVE" },
      { name: "Java (JDK 17/21)", value: 88, status: "OPTIMAL" },
      { name: "C++ (OOP & STL)", value: 85, status: "COMPILED" },
    ],
  },
  {
    ...
    icon: <FiGrid />,
    skills: [
      { name: "React", value: 80, status: "RENDERED" },
      { name: "JavaScript (ES6+)", value: 85, status: "LOADED" },
      { name: "Tailwind CSS", value: 90, status: "STYLISH" },
    ],
  },
  {
    title: "Databases & Scripts",
    icon: <FiDatabase />,
    skills: [
      { name: "MySQL", value: 80, status: "CONNECTED" },
      { name: "Django & Python", value: 70, status: "THREAD_OK" },
      { name: "PHP & REST APIs", value: 75, status: "RESOLVED" },
    ],
  },
];
